...
$(function() {
    ...
    productSliderMain.owlCarousel({
        ...
        productSliderNav.find('.owl-dot[data-target="' + slideActive + '"]').trigger('click');
    });
    ...
    $('.product-panel-buttons *').on('click', function () {
       $(this).toggleClass('active');
    });

    $('select').customSelect();

    $('.product-description-toggle').on('click', function () {
    ...
    $('.user-reg').on('click', function () {
       $('.modal-log .tabs-nav-item:last-child').trigger('click');
    });

    $('.user-login').on('click', function () {
       $('.modal-log .tabs-nav-item:first-child').trigger('click');
    });
    ...
    $('.modal-close, .modal-shadow').on('click', function () {
       $('.modal').removeClass('open');
    });
    ...
    $('.header-toggle').on('click', function () {
       ...
       $('.header-in').slideToggle('fast');
    });

    $('.back').on('click', function () {
        $(this).removeClass('active');
        $('.header-toggle').removeClass('active');
        $('.header-in').slideUp('fast');
    });
    ...
    $('.menu .folder a').on('click', function (e) {
        e.preventDefault();
    ...
    $('.copy-button').on('click', function () {
       var copyVal = $(this).siblings('.copy-field').text();
        var temp = $('<input>');
        $('body').append(temp);
    ...
    $('.order-id-filled').on('click', function () {
        var textBlock = $(this).text();
        $(this).siblings().find('input').val(textBlock);
       $(this).addClass('edit');
    });

    $('.order-id button').on('click', function () {
        var textBlock = $(this).parent().siblings('.order-id-filled');
        var inputBlock = $(this).siblings('input');
        if(inputBlock.val().length == 0){
            textBlock.text('ххх-ххххххх-ххххххх');
        }else{
            textBlock.text(inputBlock.val());
        }
        textBlock.removeClass('edit');
    });

    $('.table-link.toggle').on('click', function () {
       $(this).toggleClass('active');
    });
